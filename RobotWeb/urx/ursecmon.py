...
class SecondaryMonitor(Thread):
    ...
    def __init__(self, host, retries=3):
        ...
        # issue no6 (de ce crapa ur-ul): retries reconnection for a number of retries
        ...
        for _ in range(retries):
            ...
            raise TimeoutException("Could not establish connection after {} attempts".format(retries))
